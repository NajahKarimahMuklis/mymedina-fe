...
function CustomerPayment() {
    ...
    try {
      ...
      if (latestPayment && latestPayment.status !== payment?.status) {
        ...
        if (latestPayment.status === "SETTLEMENT") {
          ...
          ["EXPIRE", "CANCEL", "DENY"].includes(latestPayment.status)
        ) {
  ...
  const createPayment = async () => {
    try {
      ...
      if (
        errMsg.includes("tidak dapat dibayar") ||
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm lg:text-base">
                  Nomor Pesanan:{" "}
                  <span className="font-bold">{order.nomorOrder}</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {payment && (
              <div className="bg-white rounded-2xl shadow-md border border-pink-100 p-6">
                ...
                <div
                  className={`flex items-center gap-4 p-5 rounded-xl border-2 ${statusConfig.color}`}
                >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-yellow-700">
                            Kadaluarsa: {formatDateTime(payment.kadaluarsaPada)}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-700">
                          Diterima pada{" "}
                          {formatDateTime(payment.waktuSettlement)}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                {["EXPIRE", "CANCEL", "DENY"].includes(payment.status) &&
                  canCreatePayment() && (
                    <div className="mt-6 bg-red-50 border border-red-200 rounded-xl p-5">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <p className="font-bold text-red-800 text-lg">
                          Pembayaran{" "}
                          {payment.status === "EXPIRE" ? "Kadaluarsa" : "Gagal"}
                        </p>
                      </div>
                      <button
                ...
                {order.items.map((item, idx) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-bold text-[#cb5094] mt-2">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="border-t pt-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-2xl text-[#cb5094]">
